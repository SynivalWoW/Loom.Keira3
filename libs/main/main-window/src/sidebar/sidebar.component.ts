...
import { ShapeshiftHandlerService } from '@keira/features/shapeshift';
...
export class SidebarComponent {
  ...
  protected readonly shapeshiftHandlerService = inject(ShapeshiftHandlerService);
